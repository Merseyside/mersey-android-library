...
//import com.merseyside.adapters.interfaces.sorted.ISimpleAdapter
...
//) : SimpleAdapter<Item, Model>(scope), ISimpleAdapter<Item, Model>
...
//    }
//
//    override val modelList: List<Model>
